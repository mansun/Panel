...
INSERT INTO `panel`.`articulo` (`artID`, `artDatCre`, `artTit`, `artTxt`, `artImx`, `artLayout`, `artClas`, `artUsuID`) VALUES (NULL, '2015-03-05', 'Alonso: Estaré al 100% en Malasia', 'Fernando Alonso lanzó por las redes sociales un juego que no es sino una forma de responder a las teorías sobre lo primero que él dijo tras despertarse de su accidente', 'img/imagen1.jpg', '2', '0', '1');
INSERT INTO `panel`.`articulo` (`artID`, `artDatCre`, `artTit`, `artTxt`, `artImx`, `artLayout`, `artClas`, `artUsuID`) VALUES (NULL, '2015-03-04', 'Illarramendi, Lucas o Khedira, la duda de Carlo en San Mamés', 'Carlo Ancelotti no desveló quiénes compondrán el centro del campo del Real Madrid en San Mamés.', 'img/imagen2.jpg', '3', '1', '2');
